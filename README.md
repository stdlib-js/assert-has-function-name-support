...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-has-function-name-support/tags). For example,

```javascript
hasFunctionNameSupport = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-function-name-support@v0.1.0-umd/browser.js' )
```
